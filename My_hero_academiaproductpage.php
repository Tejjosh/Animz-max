...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['product_id'])) {
  ...
  header("Location: My_hero_academiaproductpage.php");
  exit();
}


// Fetch products from database
$sql = "SELECT * FROM products WHERE category = 'My Hero Academia'";
...
<head>
  ...
  <title>My hero Academia_Products_Animz Max</title>
 <link rel="stylesheet" href="productpages.css"/>
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
</head>
<body class="MyheroAcademiaproductpage">
  <header>
