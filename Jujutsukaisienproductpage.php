...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['product_id'])) {
  ...
  header("Location: Jujutsukaisienproductpage.php");
  exit();
}
...
$sql = "SELECT * FROM products WHERE category = 'Jujutsu Kaisen'";
...
<head>
  ...
  <title>Jujutsu Kaisien_Products_Animz Max</title>
 <link rel="stylesheet" href="productpages.css"/>
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
</head>
<body class="Jujutsukaisienproductpage">
  <header>
