...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['product_id'])) {
  ...
  header("Location: fire_forceproductpage.php");
  exit();
}
...
$sql = "SELECT * FROM products WHERE category = 'Fire Force'";
...
<head>
  ...
  <title>Fire Forceproductpage_Products_Animz Max</title>
 <link rel="stylesheet" href="productpages.css"/>
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
  <title>Background Image</title>
</head>
<body class="fireforceproductpage">
  <header>
